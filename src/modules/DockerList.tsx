      ...
      <div className="border-b border-macos-separator px-4 py-3">
        <div className="flex items-start justify-between">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            {isAiEnabled() && (
              <button onClick={() => setAiOpen(true)} className="flex h-8 w-8 items-center justify-center rounded-lg hover:bg-white/5 transition-colors shrink-0" title="AI 分析" style={{ WebkitAppRegion: "no-drag" } as React.CSSProperties}>
